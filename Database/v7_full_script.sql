...
ALTER TABLE book_copy_position
ADD CONSTRAINT UK_position_rfid UNIQUE (rfid);
...
(2, 'Lê Linh', 'VN', 1970),
(3, 'Jules Verne', 'US', 1970),
(4, 'Edith Hamilton', 'US', 1970),
(5, 'Viktor E. Frankl', 'US', 1970),
(6, 'Fujiko F Fujio', 'US', 1970),
(7, 'G. Willow', 'US', 1970),
...
insert into book_copy_position (id, shelf, line, rfid) values 
(1, 'A1', 1, 'E28068940000500BB957ACAE'),
(2, 'A1', 2, 'E28068940000400BB957A4AE'),
(3, 'A2', 1, 'E28068940000400BB957A8AE');
